...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition-all ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
        top: "inset-x-0 top-20 ml-4 mr-4 border-b rounded-b-md data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top data-[state=open]:animate-[slideInFromTop_0.2s_cubic-bezier(0.4,0,0.2,1)] data-[state=closed]:animate-[slideOutToTop_0.15s_cubic-bezier(0.4,0,0.2,1)]",
        bottom:
